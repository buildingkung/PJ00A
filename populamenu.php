...
$sql_1 = "SELECT * FROM `food` where Id_food = $ran_1";
$result_1 = $conn->query($sql_1);
$sql_2 = "SELECT * FROM `food` where Id_food = $ran_2";
$result_2 = $conn->query($sql_2);
$sql_3 = "SELECT * FROM `food` where Id_food = $ran_3";
$result_3 = $conn->query($sql_3);
$sql_4 = "SELECT * FROM `food` where Id_food = $ran_4";
$result_4 = $conn->query($sql_4);
$sql_5 = "SELECT * FROM `food` where Id_food = $ran_5";
$result_5 = $conn->query($sql_5);
$sql_6 = "SELECT * FROM `food` where Id_food = $ran_6";
$result_6 = $conn->query($sql_6);
$sql_7 = "SELECT * FROM `food` where Id_food = $ran_7";
$result_7 = $conn->query($sql_7);
$sql_8 = "SELECT * FROM `food` where Id_food = $ran_8";
$result_8 = $conn->query($sql_8);
$sql_9 = "SELECT * FROM `food` where Id_food = $ran_9";
$result_9 = $conn->query($sql_9);

$sql_10 = "SELECT * FROM `food` where Id_food = $ran_10";
$result_10 = $conn->query($sql_10);
$sql_11 = "SELECT * FROM `food` where Id_food = $ran_11";
$result_11 = $conn->query($sql_11);
$sql_12 = "SELECT * FROM `food` where Id_food = $ran_12";
$result_12 = $conn->query($sql_12);
$sql_13 = "SELECT * FROM `food` where Id_food = $ran_13";
$result_13 = $conn->query($sql_13);
$sql_14 = "SELECT * FROM `food` where Id_food = $ran_14";
$result_14 = $conn->query($sql_14);
$sql_15 = "SELECT * FROM `food` where Id_food = $ran_15";
$result_15 = $conn->query($sql_15);
$sql_16 = "SELECT * FROM `food` where Id_food = $ran_16";
$result_16 = $conn->query($sql_16);
$sql_17 = "SELECT * FROM `food` where Id_food = $ran_17";
$result_17 = $conn->query($sql_17);
$sql_18 = "SELECT * FROM `food` where Id_food = $ran_18";
$result_18 = $conn->query($sql_18);
...
$sqlpop = "SELECT DISTINCT food.Id_food,food.name,food.name_eng,food.price,food.imgname,SUM(bill_detail.Quantity),food.status FROM food INNER JOIN bill_detail ON food.name = bill_detail.Product_Name WHERE NOT name = 'ข้าวสวยหอมมะลิ' AND NOT name = 'ข้าวกล้อง' Group by Product_Name ORDER BY SUM(bill_detail.Quantity) DESC LIMIT 10";
$resultpop = $conn->query($sqlpop);
//$rowpop = mysqli_fetch_array($resultpop);
...
<body class="animsition">
    ...
    <!-- Title Page -->
    <section>
        <img src="img/112.jpg" style="width:100%;height:50%;">
    </section>
        ...
        <div class="content-intro bg-white p-t-77 p-b-133">
            <div class="container">
                ...
                <div class="row">
                    ...
                    <?php
                    while ($row = mysqli_fetch_array($resultpop)) {
                        echo "<div class='col-md-4 p-t-30'>";
                        echo " <div class='blo1'>";
                        echo "<div class='wrap-pic-blo1 bo-rad-10 hov-img-zoom'>";
                        echo "<img src='Foodlis/" . $row['imgname'] . "' alt='IMG-INTRO' id='" . $row['name'] . ":" . $row['price'] . ":" . $row['Id_food'] . "'  onclick='a(this.id)'>";
                        echo "</div>";
                        $ddd = $row['name'] . ":" . $row['price'];
                        ...
                        {
                            echo "<button id='" . $row['name'] . ":" . $row['price'] . ":" . $row['Id_food'] . "' class='button' onclick='a(this.id)'>ใส่ตระกร้า <i class='fa fa-shopping-cart'></i></button>";
                        }
                        
                        echo "<div class='wrap-text-blo1 p-t-35'>";

                        echo "<h4 class='txt5 color0-hov trans-0-4 m-b-13'>" . $row['name'] . " / " . $row['name_eng'] . "</h4>";


                        echo "<p class='m-b-20'>" . $row['price'] . " Baht</p>";
